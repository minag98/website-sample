            ...
            <div class="profile-content-right py-5">
              ...
              <div class="tab-content px-3 px-xl-5" id="myTabContent">
                ...
                <div class="tab-pane fade active show" id="timeline" role="tabpanel" aria-labelledby="timeline-tab">
                  <a href="{{ route('uPost') }}" class="btn btn-outline-dark btn-lg btn-block"><b>اضافه کردن پست</b></a>
                  <div class="container">
                    <div class="row">
                      <div class="col-md-12">
                        <div class="panel">
              ...
              <div class="alert alert-success" role="alert" style="text-align:right;margin-left: 30%; margin-top:5%;">
                ...
                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                  <a href="{{ route('uCategory') }}" class="btn btn-outline-dark btn-lg btn-block"><b>اضافه کردن دسته</b></a>
                  <div class="container">
                    <div class="row">
                      <div class="col-md-12">
                        <div class="panel">
