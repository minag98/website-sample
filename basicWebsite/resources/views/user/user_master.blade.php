          ...
          <div id="sidebar" class="sidebar sidebar-with-footer">
            ...
            <div class="app-brand">
              <a href="/">
                ...
                <span class="brand-name">Web Site</span>
              </a>
            </div>
              ...
              <ul class="nav sidebar-inner" id="sidebar-menu">
                  ...
                  <li  class="has-sub active expand" >
                    ...
                    <ul  class="collapse show"  id="dashboard"
                      ...
                      <div class="sub-menu">
                            ...
                            <li  class="active" >
                              <a class="sidenav-item-link" href="{{ route('uCategory') }}">
                                <span class="nav-text"><b>اضافه کردن دسته</b></span>
                                
                              </a>
                            </li>

                            <li  class="active" >
                              <a class="sidenav-item-link" href="{{ route('uPost') }}">
                                <span class="nav-text"><b>اضافه کردن پست</b></span>
                  ...
                  <li  class="has-sub" >
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#pages"
                      ...
                      <span class="nav-text">Web Site</span> <b class="caret"></b>
                    </a>
                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown user-menu">
                    <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                      ...
                      <img src="{{ Auth::user()->profile_photo_path }}" class="user-image"/>
                      @else
                      <img src="{{ asset('image/default.png') }}" class="user-image"/>
                      @endif
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                      ...
                      <li class="dropdown-header">
                        @if (Auth::user()->status === 1)
                        <img src="{{ Auth::user()->profile_photo_path }}" class="img-circle"/>
                        @else
                        <img  src="{{ asset('image/default.png') }}" class="img-circle"/>
                        @endif
                      ...
                      <li>
                        <a href="{{ route('profile.info') }}">
                          <i class="mdi mdi-account"></i> به روز رسانی پروفایل 
                        </a>
                      </li>
                      <li>
                        <a href="{{ route('change.pass') }}"> <i class="mdi mdi-settings"></i> تغییر رمز عبور </a>
                      </li>
